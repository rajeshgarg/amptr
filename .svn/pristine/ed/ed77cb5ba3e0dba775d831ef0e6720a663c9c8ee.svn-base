...
/**
 * This <code>IDocumentService</code> contains all the methods declarations for the document related operations like : saving/deleting/updating documents, fetching documents etc 
 * 
...
public interface IDocumentService {
	 ...
	 */
	List<Document> getFilteredDocuments(long componentId, FilterCriteria filterCriteria,
	 ...
	 */
	Map<Long, List<Document>> getDocumentsForComponents(List<Long> componentIdList, String type);
	...
	/**
	 * Saves {@link Document} in AMPT database and {@link File}} content in the File System
	 * @param 	document
	 * 			{@link Document} to be saved in the AMPT database
	 * @param 	body
	 * 			Content of the File to be saved in the {@link File} in the File System
	 * @throws 	IOException
	 * 			Might occur while saving the document to the File System
	 */
	void saveDocumentAndFile(final Document document, final byte[] body) throws IOException;
}

...
function initializeOptionsGrid(){
	...
	optionsGridOpts.colNames = ['Option Id','', 'Name' , 'Start Date' , 'End Date','Budget ($)','Effective CPM','Total Investment ($)','No. Of Versions','Option No','Default', 'Threshold Value', 'Pricing Reviewed On', 'Viewable'];
	...
	optionsGridOpts.colModel = [
			...
			{name:'defaultDisplay', index:'defaultDisplay', fixed:true, resizable:false, sortable:false, width:30},
		    {name:'optionName', index:'optionName', sortable:false, resizable:false, width:30, formatter:optionslinkFormatter},
		    {name:'startDate', index:'startDate', sortable:false, resizable:false, width:35},
	    	{name:'endDate', index:'endDate', sortable:false, resizable:false, width:35},
	    	{name:'budget', index:'budget', sortable:false, resizable:false, align:"right", width:50},
	    	{name:'netCpm', index:'netCpm', sortable:false, resizable:false, align:"right", width:50},
			{name:'offeredBudget', index:'offeredBudget', sortable:false, align:"right", resizable:false, width:60},
			{name:'proposalVersion', index:'proposalVersion', sortable:false, align:"right", resizable:false, width:55},
			...
			{name:'isOptionViewable', index:'isOptionViewable', sortable:false, resizable:false, width:40}
	];

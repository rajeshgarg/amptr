...
<html>
	...
	<body>
		...
		<div id="mainDiv">
	  		<div id="loginDiv">
	    		<div id="toptitle"><img src="./images/logo_login.png" width="297" height="36" align="absmiddle"/></div>
	    			<div id="loginformDiv">
	     				<form name="frmLogin" action="<c:url value='/j_spring_security_check'/>" method="post">
					        <table width="100%" cellpadding="0" cellspacing="0">
					        	<tbody>
					            	<tr>
					              		<td colspan="2" class="labelBold"><spring:message code="message.generic.loginErrorScreen"/></td>
					            	</tr>
					            	<tr>
					              		<td width="40%" class="LabelNormalright"><spring:message code="label.generic.userID"/>&nbsp;:&nbsp;</td>
					              		<td width="60%"><input class="textbox" type="text" name="j_username" id="j_username" style="padding: 1px 3px 1px 3px;" onkeypress="handleEnterKey()" /></td>
					            	</tr>
						            <tr>
						            	<td width="40%" class="LabelNormalright"><spring:message code="label.generic.password"/>&nbsp;:&nbsp;</td>
						            	<td width="60%"><input type="password" class="textbox" name="j_password" id="j_password" style="padding: 1px 3px 1px 3px;" onkeypress="handleEnterKey()" /></td>
						            </tr>
					            	<tr height="25">
					              		<td colspan="2" class="alert" id="alerts">
				              				<div align="center" style="padding:0px; margin:0px"><spring:message code="message.generic.invalidCredentials"/></div>
					              		</td>
					            	</tr>

...
/**
 * This <code>IDashboardService</code> includes all the declarations for the methods including functionalities like : fetching Proposal's data for both graph and grid in the dash-board view, all CRUD operations for 
...
public interface IDashboardService {
	 ...
	 */
	List<Proposal> getDashboardProposal(final List<FilterCriteria> filterCriteriaList);
	 ...
	 */
	List<Proposal> getProposalList(final List<FilterCriteria> filterList, final PaginationCriteria pgCriteria, final SortingCriteria sortCriteria);
	 ...
	 */
	int getProposalCount(final List <FilterCriteria> filterCriteriaList);
	 ...
	 */
	List<UserFilter> getUserSaveFilterList(long userId);
